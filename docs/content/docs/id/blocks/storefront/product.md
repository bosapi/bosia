...
description: Galeri lengket, buy box dengan opsi, baris kepercayaan, dan accordion detail.
demo: StorefrontProductDemo
---

Blok penyusun halaman detail produk (PDP). Letakkan galeri dan buy box berdampingan, lalu tumpuk
baris kepercayaan dan accordion di bawah opsi.
