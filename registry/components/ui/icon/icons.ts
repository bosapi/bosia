/**
 * Lucide icon SVG inner content — zero dependencies.
 * Paths sourced from lucide-static (https://unpkg.com/lucide-static).
 * Browse icons at https://lucide.dev/icons
 *
 * To add an icon:
 * 1. Find it on lucide.dev
 * 2. Copy the inner SVG (everything inside <svg>...</svg>)
...
export const icons = {
	...
	package: `<path d="M11.525 2.295a.53.53 0 0 1 .95 0l.089.18a9.98 9.98 0 0 0-.089-.18Z"/><path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.29 7 12 12 20.71 7"/><line x1="12" x2="12" y1="22" y2="12"/>`,
