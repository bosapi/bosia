...
<li
	class="group flex items-center gap-3 rounded-md border border-border px-4 py-3 transition-colors hover:bg-accent/50"
>
	<!-- Toggle -->
	<form method="POST" action="?/toggle">
		...
		<button
			type="submit"
			class="flex size-5 items-center justify-center rounded border border-input transition-colors hover:border-primary {todo.completed
