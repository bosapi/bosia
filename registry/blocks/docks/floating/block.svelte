...
<div class="mx-auto w-full max-w-[390px] px-4 pb-4">
	<nav
		class="flex items-center justify-around rounded-2xl border border-border bg-card px-3 py-2 text-card-foreground shadow-lg"
	>
